    ...
    <div className="flex justify-center items-center min-h-screen p-5 bg-gradient-to-br from-primary to-secondary">
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          <h1 className="text-4xl text-primary mb-2">❤️ Dating App</h1>
          <p className="text-gray-500 text-sm">Platform Khusus untuk Kami Berdua</p>
        </div>

        <div className="flex gap-3 mb-8">
          <Link to="/login" className="flex-1 py-3 px-4 border-2 border-primary bg-white text-primary rounded-lg text-base cursor-pointer transition-all duration-300 text-center no-underline hover:bg-indigo-50">
            Login
          </Link>
        ...
        <form onSubmit={handleSubmit}>
          <h2 className="mb-5 text-gray-800 text-xl font-semibold">Register</h2>
          ...
          <div className="mb-5">
            <label className="block mb-2 text-gray-700 font-medium">Nomor Handphone</label>
            <input
              type="tel"
              value={phone}
